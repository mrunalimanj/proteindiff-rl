...
def finetune(
    ...
    if from_dir:
        local_dir = snapshot_download(from_dir)
        model = modelling.BertForDiffusion.from_dir(local_dir)
        cfg = BertConfig.from_json_file(os.path.join(local_dir, "config.json"))
