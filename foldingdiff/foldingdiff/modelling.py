...
class BertForAutoregressiveBase(BertForDiffusionBase):
    ...
    def forward(
        ...
        inputs_upscaled = self.embeddings(inputs_upscaled, position_ids=position_ids)
        print("shape of inputs_upscaled", inputs_upscaled.shape)
        print("shape of extended_attention_mask", extended_attention_mask.shape)
        print("shape of output_attentions", output_attentions.shape)
        print("shape of output_hidden_states", output_hidden_states.shape)
