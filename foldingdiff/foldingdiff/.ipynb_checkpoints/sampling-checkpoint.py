...
def p_sample(
    ...
    print("sample probabilities?", flush=True)
    print(model(x, t, attention_mask=attn_mask).__dict__, flush=True)
    print(model(x, t, attention_mask=attn_mask).logits, flush=True)
